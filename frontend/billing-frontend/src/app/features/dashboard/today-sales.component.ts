    ...
    <div class="page-wrapper">
      ...
      <div class="page-top-bar">
        ...
        <div class="page-header">
          <h2 class="page-title">Today's Sales</h2>
      ...
      <div class="chart-card">
        <div class="chart-card-header">
          ...
          <span class="chart-subtitle">{{ chartData.length }} products sold today</span>
        </div>
        ...
        <div class="empty-chart" *ngIf="chartData.length === 0">
          ...
          <p class="empty-sub">Product sales data will appear here once you create bills</p>
        </div>
      </div>
